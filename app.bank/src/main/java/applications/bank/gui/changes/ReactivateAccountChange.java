...
public class ReactivateAccountChange extends AbstractChange {
	private static final String CLASS_NAME = ReactivateAccountChange.class.getName();
	private static final Logger LOGGER = ApplicationConfiguration.logger();

	private Account account;

	public ReactivateAccountChange(Account account) {
