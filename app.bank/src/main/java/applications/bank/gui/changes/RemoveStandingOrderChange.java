...
public class RemoveStandingOrderChange extends AbstractChange {
	private static final String CLASS_NAME = RemoveStandingOrderChange.class.getName();
	private static final Logger LOGGER = ApplicationConfiguration.logger();

	private StandingOrder standingOrder;

	public RemoveStandingOrderChange(StandingOrder standingOrder) {
